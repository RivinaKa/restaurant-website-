...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <input type="submit" value="place order" class="btn <?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>" style="width:100%; background:var(--green); color:var(--black);" name="submit">
   </div>
